...
//   return (
//     <div className="max-w-6xl mx-auto bg-white rounded-lg py-6 px-4">
...
//             <button type="submit" disabled={loading} className="w-full bg-green-500 text-white rounded-md py-3 flex items-center justify-center gap-2">
//               <IoIosSend className="h-6 w-6" /> {loading ? "Sending..." : "Send Message"}
//             </button>
//           </form>
//         </div>
//       </div>
...
//   <div className="flex flex-col items-center justify-center rounded-lg p-4 text-center border border-gray-300 shadow-md">
//     <Icon className="text-3xl text-blue-600" />
//     <h4 className="text-gray-800 font-bold mt-2">{title}</h4>
...
//   <div>
//     <input type={type} name={name} placeholder={placeholder} value={value} onChange={onChange} className="w-full border rounded-md py-2 px-3 outline-none" />
...
//   <div>
//     <textarea name={name} placeholder={placeholder} rows={rows} value={value} onChange={onChange} className="w-full border rounded-md py-2 px-3 outline-none" />
//     {error && <p className="text-red-500 text-sm mt-1">{error}</p>}
//   </div>
// );
    ...
    <div className="max-w-6xl mx-auto bg-white dark:bg-[var(--light-grey)] rounded-lg py-6 px-4">
      <div className="grid lg:grid-cols-3 gap-6 items-center">
        ...
        <div className="lg:col-span-2 bg-gray-100 dark:bg-[var(--light-grey)] rounded-lg p-6">
          <h2 className="text-3xl font-bold text-center text-gray-800 dark:text-white mb-6">Get In Touch</h2>
          <form onSubmit={handleSubmit} className="max-w-md mx-auto space-y-4">
            <InputField type="text" name="name" placeholder="Name" value={contactData.name} onChange={handleInputChange} error={errors.name} />
            <InputField type="text" name="email" placeholder="Email" value={contactData.email} onChange={handleInputChange} error={errors.email} />
            <InputField type="text" name="mobile" placeholder="Mobile No." maxLength={10} value={contactData.mobile} onChange={handleInputChange} error={errors.mobile} />
