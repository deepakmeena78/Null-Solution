...
function HeaderPage() {
  ...
  return (
    <header
      className={`w-[90%] max-w-6xl bg-[var(--dark-theme)] fixed top-4 left-1/2 -translate-x-1/2 z-50 rounded-2xl shadow-md transition-transform duration-500 ${
        showHeader ? "translate-y-0" : "-translate-y-32"
      }`}
    >
      <div className="px-6 py-4 flex items-center justify-between md:gap-8">
      ...
      {menuOpen && (
        <div className="md:hidden px-6 pb-4 space-y-3 bg-white dark:bg-[var(--dark-theme)] rounded-b-2xl">
          ...
          <a href="/contact">
            <button className="w-full bg-[var(--dark-blue)] hover:bg-[var(--dark-theme)] text-white text-sm font-semibold px-4 py-2 rounded-full shadow-lg transition-all duration-300">
              Join Us
            </button>
          </a>
        </div>
