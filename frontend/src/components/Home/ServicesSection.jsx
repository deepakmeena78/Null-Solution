...
//     bg: "bg-gradient-to-br from-var[var(--dark-theme)] to-pink-400",
//   },
//   {
...
//     icon: <FaShoppingCart className="text-4xl text-gray-800" />,
//     bg: "bg-white border",
//   },
// ];
...
//             viewport={{ once: true }}
//             className={`rounded-2xl p-6 shadow-lg hover:scale-105 transform transition-all duration-300 relative group ${service.bg}`}
//           >
//             <div className="mb-4 flex justify-center">{service.icon}</div>
//             <h3
//               className={`text-lg font-semibold text-center ${
//                 service.bg.includes("white") ? "text-gray-800" : "text-white"
//               }`}
//             >
//               {service.title}
//             </h3>
...
//                   service.bg.includes("white")
//                     ? "text-var[var(--dark-theme)] hover:text-pink-800"
...
//             {/* Hover overlay */}
//             <div className="absolute inset-0 opacity-0 group-hover:opacity-100 bg-black/10 transition duration-300 rounded-2xl z-0" />
//           </motion.div>
//         ))}
//       </div>
